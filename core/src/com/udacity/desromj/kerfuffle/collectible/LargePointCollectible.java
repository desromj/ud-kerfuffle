 ...
 */
public class LargePointCollectible extends Collectible
{
    public LargePointCollectible(float x, float y) {
        super(x, y);
    }
    ...
    {
        Score.instance.addPoints(Constants.COLLECTIBLE_LARGE_POINT_AMOUNT);
    }
}
